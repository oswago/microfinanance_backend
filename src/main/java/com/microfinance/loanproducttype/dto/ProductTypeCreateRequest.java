...
public class ProductTypeCreateRequest {
    ...
    @Size(min = 2, max = 20, message = "Product type code must be between 2 and 20 characters")
    private String code;
    ...
    private Boolean requiresBusinessPlan = false;
    private Boolean requiresCreditCheck = true;
